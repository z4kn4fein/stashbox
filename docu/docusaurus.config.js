...
const config = {
  ...
  organizationName: 'z4kn4fein', // Usually your GitHub org/user name.
  projectName: 'stashbox', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/z4kn4fein/stashbox/tree/main/docu',
        },
        theme: {
