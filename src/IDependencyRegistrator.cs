...
namespace Stashbox
{
    ...
    public interface IDependencyRegistrator
    {
        ...
        IStashboxContainer RegisterType<TFrom, TTo>(Action<IFluentServiceConfigurator<TTo>> configurator = null)
            where TFrom : class
        ...
        /// <returns>The <see cref="IStashboxContainer"/> which on this method was called.</returns>
        [Obsolete("RegisterType has been renamed to Register.")]
        IStashboxContainer RegisterType<TFrom>(Type typeTo, Action<IFluentServiceConfigurator<TFrom>> configurator = null)
            where TFrom : class;
        ...
        /// <returns>The <see cref="IStashboxContainer"/> which on this method was called.</returns>
        [Obsolete("RegisterType has been renamed to Register.")]
        IStashboxContainer RegisterType(Type typeFrom, Type typeTo, Action<IFluentServiceConfigurator> configurator = null);
        ...
        /// <returns>The <see cref="IStashboxContainer"/> which on this method was called.</returns>
        [Obsolete("RegisterType has been renamed to Register.")]
        IStashboxContainer RegisterType<TTo>(Action<IFluentServiceConfigurator<TTo>> configurator = null)
             where TTo : class;
        ...
        /// <returns>The <see cref="IStashboxContainer"/> which on this method was called.</returns>
        [Obsolete("RegisterType has been renamed to Register.")]
        IStashboxContainer RegisterType(Type typeTo, Action<IFluentServiceConfigurator> configurator = null);
        ...
        /// <param name="configurator">The configurator for the registered types.</param>
        /// <returns>The <see cref="IStashboxContainer"/> which on this method was called.</returns>
        IStashboxContainer Register<TFrom, TTo>(Action<IFluentServiceConfigurator<TTo>> configurator = null)
            where TFrom : class
            where TTo : class, TFrom;
        ...
        /// <param name="configurator">The configurator for the registered types.</param>
        /// <returns>The <see cref="IStashboxContainer"/> which on this method was called.</returns>
        IStashboxContainer Register<TFrom>(Type typeTo, Action<IFluentServiceConfigurator<TFrom>> configurator = null)
            where TFrom : class;
        ...
        /// <param name="configurator">The configurator for the registered types.</param>
        /// <returns>The <see cref="IStashboxContainer"/> which on this method was called.</returns>
        IStashboxContainer Register(Type typeFrom, Type typeTo, Action<IFluentServiceConfigurator> configurator = null);
        ...
        /// <param name="configurator">The configurator for the registered types.</param>
        /// <returns>The <see cref="IStashboxContainer"/> which on this method was called.</returns>
        IStashboxContainer Register<TTo>(Action<IFluentServiceConfigurator<TTo>> configurator = null)
             where TTo : class;
        ...
        /// <param name="configurator">The configurator for the registered types.</param>
        /// <returns>The <see cref="IStashboxContainer"/> which on this method was called.</returns>
        IStashboxContainer Register(Type typeTo, Action<IFluentServiceConfigurator> configurator = null);
