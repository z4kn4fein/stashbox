...
public class MultitenantTests
{
    ...
    public void MultitenantTests_Ensure_Container_Method_Calls_Delegate_To_Root()
    {
        ...
        container.Verify(c => c.IsRegistered<IA>(null, ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.IsRegistered(typeof(IA), null, ResolutionBehavior.Default), Times.Once);
        ...
        container.Verify(c => c.Resolve(typeof(IA), ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.Resolve(typeof(IA), new object[] { "a" }, ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.Resolve(typeof(IA), "a", new object[] { "a" }, ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.Resolve(typeof(IA), "a", ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveOrDefault(typeof(IA), ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveOrDefault(typeof(IA), new object[] { "a" }, ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveOrDefault(typeof(IA), "a", new object[] { "a" }, ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveOrDefault(typeof(IA), "a", ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveAll<IA>(ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveAll<IA>("a", ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveAll<IA>(new object[] { "a" }, ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveAll<IA>("a", new object[] { "a" }, ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveAll(typeof(IA), ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveAll(typeof(IA),"a", ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveAll(typeof(IA),new object[] { "a" }, ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.ResolveAll(typeof(IA),"a", new object[] { "a" }, ResolutionBehavior.Default), Times.Once);
        ...
        container.Verify(c => c.CanResolve<IA>(null, ResolutionBehavior.Default), Times.Once);
        container.Verify(c => c.CanResolve(typeof(IA), null, ResolutionBehavior.Default), Times.Once);
